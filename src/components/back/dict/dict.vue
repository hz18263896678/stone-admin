<template>
    <section>
        ...
        <!--列表-->
        <el-table :data="dicts" row-key="id" current-row-key highlight-current-row v-loading="loading"
            ...
            <el-table-column prop="dtName" label="类型" sortable>
            </el-table-column>
        ...
        <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" :rules="formRules" ref="addForm">
                <el-form-item label="名称" prop="dName">
                    <el-input v-model="addForm.dName" auto-complete="off"></el-input>
                </el-form-item>
                <el-form-item label="类型" prop="extend">
                    <el-select v-model="addForm.extend" placeholder="请选择">
                        <el-option
